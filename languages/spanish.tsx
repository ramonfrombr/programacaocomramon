...
export const spanishLanguage: ILanguage = {
    ...
    courseCheckout: {
        unlockFullAccess: "Desbloquea el acceso completo al curso",
        payWithPix: "Pix",
        payWithCard: "Tarjeta de crédito",
        generatingPix: "Generando código Pix...",
        scanQrCode: "Para pagar con Pix, escanea el código QR:",
        orCopyCode: "O copia el código:",
        copy: "Copiar",
        checkPaymentNow: "Verificar pago ahora",
        awaitingConfirmation: "Esperando confirmación del pago...",
        paymentApproved:
            "✅ ¡Pago aprobado! Tu acceso ha sido desbloqueado.",
        paymentRejected: "❌ Pago rechazado. Inténtalo de nuevo.",
        pixCopied: "¡Código Pix copiado!",
        copyFailed: "Error al copiar el código. Inténtalo de nuevo.",
    },
    course: {
        watchCourseURL: "",
        chaptersURL: "",
    ...
    teacherMembership: {
        ...
        tierLabel: "Plan",
        monthlyPrice: "Precio mensual (BRL)",
        monthlyPricePlaceholder: "ej.: 149",
        activeTier: "Activo y visible para estudiantes",
        stripeConfigured: "Producto y precio de Stripe configurados",
        stripeNotConfigured: "Stripe se configurará al guardar por primera vez",
        save: "Guardar plan",
        tierUpdated: "Plan de membresía actualizado",
        somethingWentWrong: "Algo salió mal",
        ...
        tagline: "Eslogan",
        features: "Beneficios",
        featuresHint: "Un beneficio por línea",
        newFeaturesHeading: "Título de novedades",
        newFeatures: "Novedades",
        exclusiveAccessHeading: "Título de acceso exclusivo",
        exclusiveAccess: "Elementos de acceso exclusivo",
