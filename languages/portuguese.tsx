...
export const portugueseLanguage: ILanguage = {
    ...
    courseCheckout: {
        unlockFullAccess: "Desbloqueie o acesso completo ao curso",
        payWithPix: "Pix",
        payWithCard: "Cartão de crédito",
        generatingPix: "Gerando Código Pix...",
        scanQrCode: "Para pagar com Pix, escaneie o QR Code:",
        orCopyCode: "Ou copie o código:",
        copy: "Copiar",
        checkPaymentNow: "Checar pagamento agora",
        awaitingConfirmation: "Aguardando confirmação do pagamento...",
        paymentApproved:
            "✅ Pagamento aprovado! Seu acesso foi liberado.",
        paymentRejected: "❌ Pagamento rejeitado. Tente novamente.",
        pixCopied: "Código pix copiado!",
        copyFailed: "Falha ao copiar o código. Tente novamente.",
    },
    course: {
    ...
    teacherMembership: {
        ...
        activeTier: "Ativo e visível para alunos",
        stripeConfigured: "Produto e preço Stripe configurados",
        stripeNotConfigured: "Stripe será configurado no primeiro salvamento",
        save: "Salvar plano",
        tierUpdated: "Plano de assinatura atualizado",
        somethingWentWrong: "Algo deu errado",
        ...
        tagline: "Tagline",
        features: "Benefícios",
        featuresHint: "Um benefício por linha",
        newFeaturesHeading: "Título das novidades",
        newFeatures: "Novidades",
        exclusiveAccessHeading: "Título do acesso exclusivo",
        exclusiveAccess: "Itens de acesso exclusivo",
