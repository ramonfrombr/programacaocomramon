...
export const frenchLanguage: ILanguage = {
        ...
        hero: {
            ...
            headingDescription: (
                <>
                    ...
                    <span className="text-black">facile</span> de maîtriser la
                    profession
                    <span className="text-black">la mieux rémunérée</span> sur
                    le marché.{" "}
                </>
            ),
    ...
    teacherMentorships: {
        filterMentorships: "Filtrer les mentorats...",
        newMentorship: "Nouveau mentorat",
    },
    teacherMentorshipCreate: {
        nameYourMentorship: "Nommer votre mentorat",
        nameYourMentorshipDescription:
            "Comment souhaitez-vous nommer votre mentorat ? Vous pourrez le modifier plus tard.",
        mentorshipTitle: "Titre du mentorat",
        mentorshipTitleInputPlaceholder:
            "ex. 'Évolution de carrière avec un mentor senior'",
        mentorshipTitleInputDescription:
            "Que couvrira ce mentorat ?",
        cancel: "Annuler",
        continue: "Continuer",
        mentorshipCreated: "Mentorat créé",
        somethingWentWrong: "Quelque chose s'est mal passé",
        titleIsRequired: "Le titre est requis",
    },
    teacherMentorshipSetup: {
        thisMentorshipIsUnpublished:
            "Ce mentorat n'est pas publié. Il ne sera pas visible pour les étudiants.",
        backToMentorships: "Retour aux mentorats",
        mentorshipSetup: "Configuration du mentorat",
        completeAllFields: "Complétez tous les champs",
        publish: "Publier",
        unpublish: "Dépublier",
        areYouSure: "Êtes-vous sûr ?",
        ...
        cancel: "Annuler",
        continue: "Continuer",
        customizeYourMentorship: "Personnalisez votre mentorat",
        ...
        mentorshipDescriptionField: {
            mentorshipDescription: "Description du mentorat",
            editDescription: "Modifier la description",
            noDescription: "Aucune description",
        },
        mentorshipImageField: {
            mentorshipImage: "Image du mentorat",
            addAnImage: "Ajouter une image",
            editImage: "Modifier l'image",
            aspectRatioRecommended:
                "Une image au format 16:9 est recommandée",
            imageIsNecessary: "L'image est nécessaire.",
        },
        mentorshipCategoryField: {
            mentorshipCategory: "Catégories du mentorat",
            ...
            categoryNamePlaceholder: "ex. Planification de carrière",
            categoryCreated: "Catégorie créée",
            categoryAlreadyExists: "La catégorie existe déjà",
        },
        addAVideo: "Ajouter une vidéo",
        mentorshipVideoField: {
            mentorshipVideo: "Vidéo du mentorat",
            uploadThisMentorshipsVideo: "Téléversez la vidéo de ce mentorat",
            editVideo: "Modifier la vidéo",
            videosCanTakeAFewMinutesToProcess:
                "Les vidéos peuvent prendre quelques minutes à traiter. Actualisez la page si la vidéo n'apparaît pas.",
        },
        mentorshipUpdated: "Mentorat mis à jour",
        somethingWentWrong: "Quelque chose s'est mal passé",
        save: "Enregistrer",
        mentorshipPublished: "Mentorat publié",
        mentorshipUnpublished: "Mentorat dépublié",
        mentorshipDeleted: "Mentorat supprimé",
    },
    seminars: {
    ...
    teacherInterviewCreate: {
        nameYourInterview: "Nommer votre entretien",
        nameYourInterviewDescription:
            "Comment souhaitez-vous nommer votre entretien ? Vous pourrez le modifier plus tard.",
        interviewTitle: "Titre de l'entretien",
        interviewTitleInputPlaceholder:
            "ex. 'Parcours en ingénierie backend'",
        interviewTitleInputDescription: "De quoi parle cet entretien ?",
        cancel: "Annuler",
        continue: "Continuer",
        interviewCreated: "Entretien créé",
        somethingWentWrong: "Quelque chose s'est mal passé",
        titleIsRequired: "Le titre est requis",
    },
    teacherInterviewSetup: {
        thisInterviewIsUnpublished:
            "Cet entretien n'est pas publié. Il ne sera pas visible pour les étudiants.",
        ...
        cancel: "Annuler",
        continue: "Continuer",
        customizeYourInterview: "Personnalisez votre entretien",
        interviewTitleField: {
            interviewTitle: "Titre de l'entretien",
            editTitle: "Modifier le titre",
            interviewTitleInputPlaceholder:
        ...
        interviewImageField: {
            interviewImage: "Image de l'entretien",
            addAnImage: "Ajouter une image",
            editImage: "Modifier l'image",
            aspectRatioRecommended:
                "Une image au format 16:9 est recommandée",
        ...
        interviewGuestField: {
            interviewGuest: "Informations sur l'invité",
            editGuest: "Modifier l'invité",
            guestName: "Nom de l'invité",
            guestCompany: "Entreprise",
            guestRole: "Poste",
            guestNamePlaceholder: "ex. Marie Dupont",
            guestCompanyPlaceholder: "ex. Acme Corp",
            guestRolePlaceholder: "ex. Ingénieure Staff",
            noGuest: "Aucune information sur l'invité",
        },
        ...
        interviewCategoryField: {
            interviewCategory: "Catégories de l'entretien",
            editCategory: "Modifier les catégories",
            noCategory: "Aucune catégorie",
            youHaveToSelectAtLeastOneItem:
                "Vous devez sélectionner au moins un élément.",
        ...
        addAVideo: "Ajouter une vidéo",
        interviewVideoField: {
            interviewVideo: "Vidéo de l'entretien",
            uploadThisInterviewsVideo: "Téléchargez la vidéo de cet entretien",
            editVideo: "Modifier la vidéo",
            videosCanTakeAFewMinutesToProcess:
                "Les vidéos peuvent prendre quelques minutes à traiter. Actualisez la page si la vidéo n'apparaît pas.",
        },
    ...
    teacherCreate: {
        ...
        courseTitleInputDescription:
            "Que souhaitez-vous enseigner dans ce cours ?",
        cancel: "Annuler",
        continue: "Continuer",
        ...
        thisCourseIsAvailableOnlyOnYouTube:
            "Ce cours est uniquement disponible sur YouTube",
    },
    teacherCourseSetup: {
    ...
    teacherMembership: {
        ...
        tierLabel: "Formule",
        monthlyPrice: "Prix mensuel (BRL)",
        monthlyPricePlaceholder: "ex. : 149",
        activeTier: "Actif et visible pour les étudiants",
        stripeConfigured: "Produit et prix Stripe configurés",
        stripeNotConfigured: "Stripe sera configuré à la première sauvegarde",
        save: "Enregistrer la formule",
        tierUpdated: "Formule d'abonnement mise à jour",
        somethingWentWrong: "Une erreur s'est produite",
        ...
        tagline: "Accroche",
        features: "Avantages",
        featuresHint: "Un avantage par ligne",
        newFeaturesHeading: "Titre des nouveautés",
        newFeatures: "Nouveautés",
        exclusiveAccessHeading: "Titre de l'accès exclusif",
        exclusiveAccess: "Éléments d'accès exclusif",
