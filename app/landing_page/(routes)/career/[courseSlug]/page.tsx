...
import { VideoPlayer } from "@/app/landing_page/(routes)/career/[courseSlug]/_components/video-player";
        ...
        <div className="p-8 md:px-32">
            <div className="flex flex-col items-center lg:items-start lg:flex-row-reverse gap-2">
                ...
                <div className="text-center lg:text-left pt-5">
                    ...
                    <Link
                        href={`/sign-up?courseId=${course.id}`}
                        className="relative"
                    >
                        ...
                        <Image
                            src={discount}
                            height={50}
                            className="absolute -top-2 right-[-85px]"
                            alt="Etiqueta 50% de desconto"
                        />
                    </Link>
                    ...
                    <p className="text-2xl text-gray-500 md:text-lg">
                        <span className="line-through font-bold">
                            {formatPrice(
                                Math.ceil((course.price! * 2) / 10) * 10,
                            )}
                        </span>{" "}
                        (50% de desconto)
                    </p>
            ...
            <Accordion
                type="multiple"
                className="border rounded-md text-base mt-10"
            >
