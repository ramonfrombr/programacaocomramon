...
import Header from "@/app/landing_page/(routes)/career/_components/header";
import CoursesSection from "@/app/landing_page/(routes)/career/_components/courses-section";
...
const CareerPage = ({ heading, image, description, slug }: CareerPageProps) => {
