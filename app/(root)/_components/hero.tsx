    ...
    return (
        ...
        >
            <div className="mb-5">
                ...
                <p className="text-gray-500 text-base md:text-lg lg:text-xl xl:text-2xl mb-3 md:mb-5">
                    {language.headingDescription}
                </p>

                <div className="text-center md:text-left">
                    <Link href="/career" data-testid="link-getting-started">
                        <Button className="rounded-full bg-blue-600 w-full md:w-[80%] p-7 lg:p-10 text-lg lg:text-2xl mb-5 hover:bg-blue-700 font-bold">
                            {language.chooseACareer}
                        </Button>
                    </Link>

                    <p className="text-slate-500 text-base md:text-lg lg:text-xl xl:text-2xl">
