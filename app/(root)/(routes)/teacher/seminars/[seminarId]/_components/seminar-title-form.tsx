...
interface SeminarTitleFormProps {
    initialData: {
        title: string;
    };
    seminarId: string;
...
export const SeminarTitleForm = ({
    initialData,
    seminarId,
}: SeminarTitleFormProps) => {
    ...
    return (
        <div className="mt-6 border bg-slate-100 roudned-md p-4">
            <div className="font-medium flex items-center justify-between">
                {language.seminarTitleField.seminarTitle}
                <Button onClick={toggleEdit} variant="ghost">
                    {isEditing ? (
                        ...
                        <>
                            ...
                            {language.seminarTitleField.editTitle}
                        </>
                    )}
                </Button>
            </div>
                                ...
                                <FormItem>
                                    <FormControl>
                                        <Input
                                            ...
                                            placeholder={
                                                language.seminarTitleField
                                                    .seminarTitleInputPlaceholder
                                            }
                                            {...field}
                                        />
                                    </FormControl>
