...
interface SeminarDescriptionFormProps {
    initialData: Seminar;
    seminarId: string;
}
...
export const SeminarDescriptionForm = ({
    initialData,
    seminarId,
}: SeminarDescriptionFormProps) => {
    ...
    return (
        <div className="mt-6 border bg-slate-100 roudned-md p-4">
            <div className="font-medium flex items-center justify-between">
                {language.seminarDescriptionField.seminarDescription}
                <Button onClick={toggleEdit} variant="ghost">
                    {isEditing ? (
                        ...
                        <>
                            ...
                            {language.seminarDescriptionField.editDescription}
                        </>
                    )}
                </Button>
            </div>
            {!isEditing && (
                ...
                >
                    {!initialData.description &&
                        language.seminarDescriptionField.noDescription}
                    {initialData.description && (
