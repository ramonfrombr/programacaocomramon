...
const CreateInterviewPage = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
            <div>
                <h1 className="text-2xl">{language.nameYourInterview}</h1>

                <p className="text-sm text-slate-600">
                    {language.nameYourInterviewDescription}
                </p>
                    ...
                    >
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>
                                        {language.interviewTitle}
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                                            disabled={isSubmitting}
                                            placeholder={
                                                language.interviewTitleInputPlaceholder
                                            }
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormDescription>
                                        {
                                            language.interviewTitleInputDescription
                                        }
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
