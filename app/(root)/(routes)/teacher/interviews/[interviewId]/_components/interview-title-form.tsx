...
interface InterviewTitleFormProps {
    initialData: {
        title: string;
    };
    interviewId: string;
...
export const InterviewTitleForm = ({
    initialData,
    interviewId,
}: InterviewTitleFormProps) => {
    ...
    return (
        <div className="mt-6 border bg-slate-100 roudned-md p-4">
            <div className="font-medium flex items-center justify-between">
                {language.interviewTitleField.interviewTitle}
                <Button onClick={toggleEdit} variant="ghost">
                    {isEditing ? (
                        ...
                        <>
                            ...
                            {language.interviewTitleField.editTitle}
                        </>
                    )}
                </Button>
            </div>
