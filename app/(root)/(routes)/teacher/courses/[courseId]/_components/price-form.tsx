  ...
  return (
    <div className="mt-6 border bg-slate-100 roudned-md p-4">
      <div className="font-medium flex items-center justify-between">
        {language.coursePriceField.coursePrice}
        <Button onClick={toggleEdit} variant="ghost">
          {isEditing ? (
            ...
            <>
              ...
              {language.coursePriceField.editPrice}
            </>
          )}
        </Button>
      </div>
      ...
      {!isEditing && (
        ...
        >
          {initialData.price
            ...
            : language.coursePriceField.noPrice}
        </p>
      )}
                ...
                <FormItem>
                  <FormControl>
                    <Input
                      ...
                      placeholder={
                        language.coursePriceField.coursePriceInputPlaceholder
                      }
                      {...field}
                    />
                  </FormControl>
