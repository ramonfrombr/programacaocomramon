...
import { ChapterActions } from "@/app/(root)/(routes)/teacher/courses/[courseId]/chapters/[chapterId]/_components/chapter-actions";
    ...
    return (
        <>
            {!chapter.isPublished && (
                <Banner
                    variant="warning"
                    label={language.thisChapterIsUnpublished}
                />
            )}
