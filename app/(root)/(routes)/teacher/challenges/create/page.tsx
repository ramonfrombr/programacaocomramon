...
const CreateChallengePage = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
            <div>
                <h1 className="text-2xl">{language.nameYourChallenge}</h1>

                <p className="text-sm text-slate-600">
                    {language.nameYourChallengeDescription}
                </p>
                    ...
                    >
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>
                                        {language.challengeTitle}
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                                            disabled={isSubmitting}
                                            placeholder={
                                                language.challengeTitleInputPlaceholder
                                            }
                                            {...field}
                                        />
                                    </FormControl>
                                    <FormDescription>
                                        {
                                            language.challengeTitleInputDescription
                                        }
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
