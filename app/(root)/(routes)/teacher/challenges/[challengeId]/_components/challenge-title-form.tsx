...
interface ChallengeTitleFormProps {
    initialData: {
        title: string;
    };
    challengeId: string;
...
export const ChallengeTitleForm = ({
    initialData,
    challengeId,
}: ChallengeTitleFormProps) => {
    ...
    return (
        <div className="mt-6 border bg-slate-100 roudned-md p-4">
            <div className="font-medium flex items-center justify-between">
                {language.challengeTitleField.challengeTitle}
                <Button onClick={toggleEdit} variant="ghost">
                    {isEditing ? (
                        ...
                        <>
                            ...
                            {language.challengeTitleField.editTitle}
                        </>
                    )}
                </Button>
            </div>
