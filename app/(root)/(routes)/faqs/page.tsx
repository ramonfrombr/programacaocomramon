...
const billingQuestions = [
    {
        question:
            "O Stripe não suporta pagamentos do meu país, vocês aceitam Pix?",
        answer: "Por enquanto, não aceitamos pagamento por Pix. Todos os pagamentos devem ser feitos com um cartão de crédito válido",
    },
    {
        question:
            "Preciso cancelar minha assinatura para não ser cobrado novamente?",
        answer: "Não, todos os planos de curso no Escola de Programação são pagos apenas uma vez. Não há assinatura para cancelar, você nunca será cobrado uma segunda vez sem comprar explicitamente outro curso.",
    },
    {
        question:
            "Como faço para excluir as informações do meu cartão de pagamento do Escola de Programação?",
        answer: "Você não precisa, no Escola de Programação nunca salvamos suas informações de pagamento no sistema. Como nossos planos são de pagamento único, não retemos suas informações pessoais.",
    },
];
