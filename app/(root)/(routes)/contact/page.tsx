    ...
    return (
        <div className="p-8 md:px-32 lg:px-52 ">
            ...
            <p className="mb-8 text-gray-500">
                ...
                pessoalmente assim que possível. Considere que você pode
                experimentar um atraso na resposta devido a feriados, finais de
                semana ou outras circunstâncias.
            </p>

            <h2 className="text-2xl mb-3">Informações de Contato</h2>

            <p className="mb-3">
                Para suporte relacionado à sua conta, envio de bugs ou perguntas
